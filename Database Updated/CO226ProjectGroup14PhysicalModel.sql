...
CREATE TABLE H_RESOURCE(
	...
	IMPORTEDDATE DATE,
    PRIMARY KEY (RNAME,MANUFACTURER,SECTIONNAME),
...
CREATE TABLE WARD(
    ...
    FOREIGN KEY (DOCTORID) REFERENCES DOCTOR(NID)
    ON UPDATE CASCADE
);
...
CREATE TABLE ISSUES(
    ...
    PRIMARY KEY (PATIENTNO,DOCTORNID,REPORTNO),
    FOREIGN KEY (PATIENTNO) REFERENCES PATIENT(PATIENTNO),
	FOREIGN KEY (DOCTORNID) REFERENCES DOCTOR(NID),
